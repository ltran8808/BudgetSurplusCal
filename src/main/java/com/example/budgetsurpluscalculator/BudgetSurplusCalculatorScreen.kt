...
fun NavigationBarExample(
    ...
    val budgetSurpluseViewModel : BudgetSurplusCalViewModel = viewModel()
    ...
    Scaffold(
        ...
        contentPadding ->
        AppNavHost(viewModel = budgetSurpluseViewModel, tipCalScreenViewModel = tipCalViewModel, navController = navController, startDestination = startDestination, modifier = Modifier.padding(contentPadding))
    }
}
